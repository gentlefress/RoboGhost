...
class RslRlPpoActorCriticCfg:
    ...
    class_name: str = "ActorCritic_MoE"
    ...
    student_class_name: str = "DiffusionPolicy"
    """The student policy class name for distillation. Default is None."""
...
class RslRlOnPolicyRunnerCfg:
    ...
    dagger: bool = False
    """Whether to dagger. Default is False."""
